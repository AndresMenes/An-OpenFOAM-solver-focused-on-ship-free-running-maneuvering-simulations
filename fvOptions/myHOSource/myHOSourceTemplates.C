...
/* Printing of Actuator Disk properties, both theorical and actual calculated from CFD */
  ...
  Info<<"J = "<<J<<nl
      ...
      <<"target efficiency behind the hull = "<<thrust*Va/(2*M_PI*diskRPS_*torque)<<nl
      <<"actual efficiency behind the hull = "<<Tdisk*Va/(2*M_PI*diskRPS_*Qdisk)<<nl
