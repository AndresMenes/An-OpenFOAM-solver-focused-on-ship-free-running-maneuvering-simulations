...
namespace fv
{
    defineTypeNameAndDebug(HOSource2, 0);
    addToRunTimeSelectionTable(option, HOSource2, dictionary);
}
}
...
bool Foam::fv::HOSource2::read(const dictionary& dict)
{
...
void Foam::fv::HOSource2::updateCells()
{
