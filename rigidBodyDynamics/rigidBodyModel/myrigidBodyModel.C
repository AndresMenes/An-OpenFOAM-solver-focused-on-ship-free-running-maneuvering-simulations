...
)
{
    ...
    countJoint_.append(cJoint.size());
...
(
    const scalarField& qOld, 
    const scalarField& qDotOld, 
    const scalarField& qDdotOld, 
    scalarField& qNew, 
    scalarField& qDotNew, 
    scalarField& qDdotNew
) const
{
    label sumJoint = 0;
    label serialDoF = 0;
...
void Foam::RBD::rigidBodyModel::readingState
(
    const scalarField& qOld, 
    const scalarField& qDotOld, 
    const scalarField& qDdotOld, 
